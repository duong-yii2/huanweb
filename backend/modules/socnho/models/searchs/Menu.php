...
namespace backend\modules\socnho\models\searchs;

use Yii;
use yii\base\Model;
use yii\data\ActiveDataProvider;
use backend\modules\socnho\models\Menu as MenuModel;

/**
 * Menu represents the model behind the search form about [[\backend\modules\socnho\models\Menu]].
 * 
