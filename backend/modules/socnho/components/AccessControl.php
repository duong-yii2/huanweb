 ...
 * ```
 * 'as access' => [
 *     'class' => 'backend\modules\socnho\components\AccessControl',
...
class AccessControl extends \yii\base\ActionFilter
{
    ...
    public function beforeAction($action)
    {
        ...
        if(Yii::$app->user->can(\common\models\User::ROLE_ADMINISTRATOR) || (!Yii::$app->user->isGuest && ($action->getUniqueId() == 'sign-in/logout' || $action->getUniqueId() == 'sign-in/account') || $action->getUniqueId() == 'sign-in/profile')){
            return true;
        }
